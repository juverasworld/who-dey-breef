...
const Popup = () => {
  ...
  return (
    <div className={`popup ${showPopup ? 'active' : ''}`}>
      <div className="content flex md:flex-row flex-col md:max-w-[60%] ">
        <div className="">

        <p className="font-bold text-4xl">Unlock The Secrets Of <br className="md:flex hidden" />Wealthy Trading in 5 Days! </p>
        ...
        <p className='mt-5 md:flex hidden'>
        ...
        <div className="">
            <Image src={pop} alt='sign up' width={400} height={300} className=" w-auto h-auto "/>
        </div>
